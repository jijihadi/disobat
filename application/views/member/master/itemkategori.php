			...
			<div class="inner-wrapper"> 
				...
				<section role="main" class="content-body">
					<header class="page-header">  
						<h2>Master Data Kategori Item</h2>  
					</header>  
					<!-- start: page -->
                    <section class="panel">
                        <header class="panel-heading">    
                            <div class="row show-grid">
                                <div class="col-md-6" align="left"><h2 class="panel-title">Data Kategori Item</h2></div>
                                <?php  
                                echo level_user('master','itemkategori',$this->session->userdata('kategori'),'add') > 0 ? '<div class="col-md-6" align="right"><a class="btn btn-success" href="#"  data-toggle="modal" data-target="#tambahData"><i class="fa fa-plus"></i> Tambah</a></div>':'';
                                ?> 
							</div>
                        </header>
        ...
        <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <section class="panel  panel-primary">
                    ...
                    <header class="panel-heading">
                        <h2 class="panel-title">Tambah Kategori Item</h2>
                    </header>
                    <div class="panel-body">
                ...
                <section class="panel  panel-primary">
                    ...
                    <div class="panel-body">
                            <div class="form-group mt-lg id">
                                <label class="col-sm-3 control-label">Nama Kategori<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="id" id="namakategori" class="form-control" required/>
                                </div>
                            </div> 
                            <div class="form-group mt-lg id">
                                <label class="col-sm-3 control-label">Lokasi<span class="required">*</span></label>
            ...
            function edit(elem){
                ...
                $.ajax({
                    ...
                    success: function(response) {  
                        ...
                        document.getElementById("namakategori").setAttribute('value', item.namakategori);
                        document.getElementById("lokasi").setAttribute('value', item.lokasi_kategori); 
                        }); 
                    }
                });  
                return false;
