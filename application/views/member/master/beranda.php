										...
										<div class="inner-menu-content">  
											...
											<div class="sidebar-widget m-none"> 
												<div class="widget-content">
                                                    ...
                                                    <?php if( $this->session->userdata('kategori')==31){?>
														<li>
															<a href="<?php echo base_url()?>master/pembeli" class="menu-item"><i class="fa fa-folder"></i> Master Apotek</a>
															<div class="item-options">
                                                    ...
                                                    <?php if( $this->session->userdata('kategori')==31){?>
														<li>
															<a href="<?php echo base_url()?>master/spg" class="menu-item"><i class="fa fa-folder"></i> Master SPG</a>
															<div class="item-options">
