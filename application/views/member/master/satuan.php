                ...
                <section class="panel panel-primary">
                    ...
                    <div class="panel-body">
                            <div class="form-group mt-lg id">
                                <label class="col-sm-3 control-label">Nama Satuan<span class="required">*</span></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group mt-lg id">
                                ...
                                <?php
                                    $ci =& get_instance();
                                    $sat = $ci->db->get('master_satuan');

                                    foreach ($sat->result() as $r) {
                                ?>
                ...
                <section class="panel panel-primary">
                    ...
                    <div class="panel-body">
                            <div class="form-group mt-lg id">
                                <label class="col-sm-3 control-label">Nama Satuan<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="id" id="namasatuan" class="form-control" required/>
                                </div>
                            </div>
                            <div class="form-group mt-lg id">
                                <label class="col-sm-3 control-label">Jumlah/Satuan Besar<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="isi_persatuan" id="isi_persatuan" class="form-control" required/>
                                </div>
                            </div>
                            <div class="form-group mt-lg id">
                                <label class="col-sm-3 control-label">Satuan Besar<span class="required">*</span></label>
                                <div class="col-sm-9">
                                <select name="satuan_besar" id="satuan_besar" class="form-control" required>
                                <?php
                                    $ci =& get_instance();
                                    $sat = $ci->db->get('master_satuan');
