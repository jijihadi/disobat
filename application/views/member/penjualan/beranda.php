										...
										<div class="inner-menu-content">  
											<div class="sidebar-widget m-none"> 
												<div class="widget-content">
													<ul class="mg-folders">
														<li>
															<a href="<?php echo base_url()?>penjualan/diskon" class="menu-item"><i class="fa fa-folder"></i> Diskon Produk</a>
															<div class="item-options">
																<a href="<?php echo base_url()?>penjualan/diskon">
																	<i class="fa fa-arrow-circle-o-left"></i>
																</a> 
															</div>
														</li> 
														<li>
															<a href="<?php echo base_url()?>penjualan/jenispembayaran" class="menu-item"><i class="fa fa-folder"></i> Jenis Pembayaran</a>
															<div class="item-options">
														...
														<li>
															<a href="<?php echo base_url()?>penjualan/kasir" class="menu-item"><i class="fa fa-folder"></i> Point Of Sales / Kasir</a>
															<div class="item-options">
