										...
										<div class="inner-menu-content">  
											<div class="sidebar-widget m-none"> 
												<div class="widget-content">
													<ul class="mg-folders">
														<li>
															<a href="<?php echo base_url()?>user/kategori" class="menu-item"><i class="fa fa-folder"></i> User Kategori</a>
														...
														<li>
															<a href="<?php echo base_url()?>user/user" class="menu-item"><i class="fa fa-folder"></i> User Management</a>
															<div class="item-options">
