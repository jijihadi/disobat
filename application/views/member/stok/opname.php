...
<html class="fixed sidebar-left-collapsed">
	...
	<body class="bgbody">
                    ...
                    <section class="panel">
                        <header class="panel-heading">    
                            <div class="row show-grid">
                                <div class="col-md-6" align="left"><h2 class="panel-title">Data Stok Opname</h2></div>
        ...
        <div class="modal fade bd-example-modal-lg" id="verifikasiData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" style="width:90%">
                <div class="modal-content">
                <section class="panel panel-primary form-group">
                    <?php echo form_open('stok/verfikasistokopname',' id="FormulirVerifikasi" enctype="multipart/form-data"');?>  
                    <header class="panel-heading">
                        <div class="row show-grid">
                                <div class="col-md-6" align="left">
                                    <h2 class="panel-title">Verifikasi Stok Opname</h2>
                                </div>
                                <div class="col-md-6" align="right">
                    ...
                    <div class="panel-body">
                        <div class="row">
                             <div class="col-md-12">
                            <table class="table table-bordered table-hover table-striped" id="stokdataverfikasi">
                                <thead>
                                    <tr>
        ...
        <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <section class="panel panel-primary">
                    <?php echo form_open('stok/stokopnametambah',' id="FormulirTambah"');?>  
                    <header class="panel-heading">
                        <h2 class="panel-title">Tambah Stok Opname</h2>
                    </header>
                    <div class="panel-body"> 
                            ...
                            <div class="form-group stok_sebelum">
                                <label class="col-sm-3 control-label">Stok Sebelumnya <span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control stok_sebelum" readonly/>
                                    <input type="hidden" name="stok_sebelum" class="stok_sebelum" required/>
                                </div>
                            </div> 
                            <div class="form-group kuantiti_berubah">
                                <label class="col-sm-3 control-label">Stok Bertambah <span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="number" name="kuantiti_berubah" class="form-control" required/>
                                </div>
                            </div> 
        ...
        <div class="modal fade" id="detailData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <section class="panel panel-primary">   
                    <header class="panel-heading">
                        <h2 class="panel-title">Detail Stok Opname</h2>
                    </header>
        ...
        <div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                    ...
                    <footer class="panel-footer"> 
                        <div class="row">
                            <div class="col-md-12 text-right"> 								
							<?php echo form_open('stok/stokopnamehapus',' id="FormulirHapus"');?>  
							<input type="hidden" name="idd" id="idddelete">  
							<input type="hidden" name="kode_item" id="iddkodeitem">  
							<input type="hidden" name="kuantiti" id="iddkuantiti"> 
		...
		var tablestok = $('#stokdata').DataTable({  
			...
			"order": [], 
			"ajax": {
				"url": "<?php echo base_url()?>stok/stokopname",
				"type": "GET"
			}, 
			"columnDefs": [
				{ 
		...
		var tablestokverfikasi = $('#stokdataverfikasi').DataTable({  
			"serverSide": true, 
			"order": [], 
			"ajax": {
				"url": "<?php echo base_url()?>stok/stokdataverfikasi",
				"type": "GET"
			}, 
			"columnDefs": [
				{ 
        ...
        document.getElementById("verifikasisubmit").addEventListener("click", function (e) { 
            document.getElementById("aksiverifikasi").setAttribute('value', 'verifikasi');
        });
        document.getElementById("verifikasihapus").addEventListener("click", function (e) { 
            document.getElementById("aksiverifikasi").setAttribute('value', 'hapus');
        });
        document.getElementById("FormulirVerifikasi").addEventListener("submit", function (e) {  
			blurForm();       
			$('.help-block').hide();
			$('.form-group').removeClass('has-error');
			document.getElementById("verifikasihapus").setAttribute('disabled','disabled');
			$('#verifikasihapus').html('Loading ...');
			$('#verifikasisubmit').html('Loading ...');
			var form = $('#FormulirVerifikasi')[0];
			...
			if ( ! data.success) {		 
                        ...
                        document.getElementById("verifikasihapus").removeAttribute('disabled'); 
                        document.getElementById("verifikasisubmit").removeAttribute('disabled');   
                        $('#verifikasisubmit').html('<i class="fa fa-check-circle"></i> Verifikasi');
                        $('#verifikasihapus').html('<i class="fa fa-trash-o"></i> Hapus');         
					...
					document.getElementById("verifikasihapus").removeAttribute('disabled'); 
					document.getElementById("verifikasisubmit").removeAttribute('disabled'); 
					$('#verifikasiData').modal('hide');     $("#checkAll").prop("checked", false);
					$('#verifikasihapus').html('<i class="fa fa-trash-o"></i> Hapus');     
					$('#verifikasisubmit').html('<i class="fa fa-check-circle"></i> Verifikasi'); 
					tablestokverfikasi.ajax.reload();  
        ...
        function pilihitem(elem){  
            ...
            function detail(elem){
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo base_url()?>stok/stokopnamedetail',
                    data: 'id=' + dataId,
                    dataType 	: 'json',
                    success: function(response) { 
                        ...
                        $.each(response, function(i, item) {
                            ...
                            datarow+="<tr><td>Nomor Referensi</td><td>: <b>"+item.nomor_ref+"</b></td></tr>";
                            ...
                            datarow+="<tr><td>Stok Sebelumnya</td><td>: "+item.stok_sebelum+" "+item.satuan_kecil+"</td></tr>";
                            datarow+="<tr><td>Stok Berkurang</td><td>: "+item.kuantiti_berubah+" "+item.satuan_kecil+"</td></tr>";
            ...
            function hapus(elem){ 
		        ...
		        var kuantiti = $(elem).data("kuantiti");
                document.getElementById("idddelete").setAttribute('value', dataId);
                document.getElementById("iddkodeitem").setAttribute('value', kodeitem);
                document.getElementById("iddkuantiti").setAttribute('value', kuantiti);
        		$('#modalHapus').modal();        
            }
