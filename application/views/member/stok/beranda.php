										...
										<div class="inner-menu-content">  
											<div class="sidebar-widget m-none"> 
												<div class="widget-content">
													<ul class="mg-folders">
														<li>
															<a href="<?php echo base_url()?>stok/keluar" class="menu-item"><i class="fa fa-folder"></i> Stok Keluar Retur Pembelian</a>
														...
														<li>
															<a href="<?php echo base_url()?>stok/barcode" class="menu-item"><i class="fa fa-folder"></i> Cetak Barcode</a>
															<div class="item-options">
														...
														<li>
															<a href="<?php echo base_url()?>stok/kartustok" class="menu-item"><i class="fa fa-folder"></i> Kartu Stok</a>
															<div class="item-options">
