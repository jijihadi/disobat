	...
	<body class="bgbody">
                                                ...
                                                <div class="widget-summary"> 
                                                    <div class="widget-summary-col">
                                                        <div class="summary">
                                                            ...
                                                            <div class="info">
                                                                <strong class="amount" id="po_hari_ini"></strong>
                                                            </div>
                                                        </div> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="widget-summary"> 
                                                    <div class="widget-summary-col">
                                                        <div class="summary">
                                                            ...
                                                            <div class="info">
                                                                <strong class="amount" id="po_minggu_ini"></strong>
                                                            </div>
                                                        </div> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="widget-summary"> 
                                                    <div class="widget-summary-col">
                                                        <div class="summary">
                                                            ...
                                                            <div class="info">
                                                                <strong class="amount" id="po_bulan_ini"></strong>
                                                            </div>
                                                        </div> 
                                                    </div>
                                                </div>
                    ...
                    <section class="panel">
                        <header class="panel-heading">    
                            <div class="row show-grid">
                                <div class="col-md-6" align="left"><h2 class="panel-title">Data PO</h2></div>
                                <?php  
                                echo level_user('pembelian','po',$this->session->userdata('kategori'),'add') > 0 ? '<div class="col-md-6" align="right"><a class="btn btn-success" href="#"  data-toggle="modal" data-target="#tambahData"><i class="fa fa-plus"></i> Tambah</a></div>':'';
                                ?> 
							</div>
                        </header>
                        <div class="panel-body"> 
        ...
        <div class="modal fade bd-example-modal-lg" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" style="width:90%">
                ...
                <section class="panel panel-primary">
                    <?php echo form_open('pembelian/potambah',' id="FormulirTambah" enctype="multipart/form-data"');?>  
                    <header class="panel-heading">
                        <h2 class="panel-title">Buat PO Baru</h2>
                    </header>
                    <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6"> 
                        <div class="form-group mt-lg nomor_po">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="nomor_po" class="form-control" value="PO" required/>
                                </div>
                            </div>
                            <div class="form-group mt-lg tgl_po">
                                <label class="col-sm-3 control-label">Tanggal PO<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="tgl_po" class="form-control tanggal" data-plugin-datepicker required/>
                                </div>
                            </div>
        ...
        <div class="modal fade bd-example-modal-lg" id="editData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" style="width:90%">
                <div class="modal-content">
                <section class="panel panel-primary">
                    <?php echo form_open('pembelian/poedit',' id="FormulirEdit" enctype="multipart/form-data"');?>  
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mt-lg nomor_po">
                                <label class="col-sm-3 control-label">Nomor PO<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" id="nomor_po_view"  class="form-control" readonly/>
                                    <input type="hidden" name="nomor_po" id="nomor_po" class="form-control" required/>
                                </div>
                            </div>
                            <div class="form-group mt-lg tgl_po">
                                <label class="col-sm-3 control-label">Tanggal PO<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="tgl_po" id="tgl_po" class="form-control tanggal" data-plugin-datepicker required/>
                                </div>
                            </div>
        ...
        var tablepo = $("#podata").dataTable({ 
            serverSide: true,
            ajax: {
                "url": "<?php echo base_url()?>pembelian/datapo",
                "type": "POST"
            },
            columns: [
                {"data": "tombol"},
