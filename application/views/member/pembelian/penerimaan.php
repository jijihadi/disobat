                    ...
                    <div class="row" style="overflow-x: auto;white-space: nowrap;"> 
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive" style="max-height:420px;"> 
                                ...
                                <thead>
                                    <tr> 
                                        <th style="min-width:200px;"det>Nomor SKU</th>
            ...
            $.ajax({
                ...
                success: function(response) { 
                    ...
                    $.each(response.datasub, function(i, itemsub) {
                        ...
                        datarow+="<td><input type='text' class='form-control' required name='no_bet[]'></td>";
                        datarow+="<td>"+itemsub.nama_item+"</td>"; 
                        datarow+="<td><input type='date' name='tgl_expired[]' required class='form-control tgl_expired'></td>";   
                        ...
                        datarow+="<input type='hidden' name='old_kuantiti[]' value='"+itemsub.kuantiti+"'>";
