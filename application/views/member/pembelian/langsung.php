	...
	<body class="bgbody">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mt-lg tgl_pembelian">
                                <label class="col-sm-3 control-label">Tanggal Faktur<span class="required">*</span></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group mt-lg tgl_pembelian">
                                <label class="col-sm-3 control-label">Total Faktur<span class="required">*</span></label>
                                <div class="col-sm-9">
                            ...
                            <div class="table-responsive" style="max-height:420px;"> 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width:200px;">Nomor Batch</th>
                                        <th style="min-width:400px;">Nama Item</th>
                                        <th style="min-width:150px;">Tanggal Expired</th>
                                        <th style="min-width:150px;">Harga Beli</th>
                                        <th style="min-width:150px;">Harga Jual 1</th>
                                        <th style="min-width:150px;">Harga Jual 2</th>
                                        <th style="min-width:150px;">Harga Jual 3</th>
                                        <th style="min-width:150px;">Harga Jual 4</th>
                                        <th style="min-width:100px;">Satuan</th>
                                        <th style="min-width:100px;">Kuantiti</th> 
                                        <th style="min-width:150px;">Diskon %</th>
                                        <th style="min-width:200px;">Sub-Total</th> 
                                    </tr>
                                </thead>
                                <tbody> 
                                </tbody>
            ...
            $.ajax({
                ...
                success: function(response) { 
                    ...
                    $.each(response.datasub, function(i, itemsub) {
                        datarow+="<tr class='item"+i+"'><td>"+itemsub.kode_item+"</td>"; 
                        datarow+="<td>"+itemsub.sku+"</td>"; 
                        datarow+="<td>"+itemsub.no_bet+"</td>"; 
                        datarow+="<td>"+itemsub.nama_item+"</td>"; 
                        datarow+="<td>"+itemsub.tgl_expired+"</td>"; 
                        datarow+="<td><input type='text' class='form-control' id='harga"+i+"' name='harga[]' ></td>";
                        datarow+="<td><input type='text' class='form-control' name='harga1[]' ></td>"; 
                        datarow+="<td><input type='text' class='form-control' name='harga2[]' ></td>"; 
                        datarow+="<td><input type='text' class='form-control' name='harga3[]' ></td>"; 
                        datarow+="<td><input type='text' class='form-control' name='harga4[]' ></td>"; 
                        datarow+="<td>"+itemsub.satuan_kecil+"</td>"; 
                        datarow+="<td>"+itemsub.kuantiti+"</td>";  
                        datarow+="<td><input type='text' class='form-control' id='diskon"+i+"' name='diskon[]' ></td>";
                        datarow+="<td><input type='text' readonly class='form-control' id='total"+i+"' name='total[]' ></td>";
                        datarow+="<input type='hidden' name='kuantiti[]' id='kuantiti"+i+"' value='"+itemsub.kuantiti+"'>";
                        datarow+="<input type='hidden' name='kode_item[]' value='"+itemsub.kode_item+"'>";
                        datarow+="<input type='hidden' name='no_bet[]' value='"+itemsub.no_bet+"'>";
                        ...
                        datarow+="</tr>"; 
                        $(".listitem").keyup(function(){
                            var harga = parseFloat($("#harga"+i).val());
                            var jumlah =  itemsub.kuantiti;
                            var diskon = parseFloat($("#diskon"+i).val());

                            total = (harga*jumlah)-((diskon/100)*(harga*jumlah));
                            hasils = total
                            ...
                            var frst = (finaltotal.length)-(i+1);
                            var numes = [];
                            for (var ix = frst; ix < finaltotal.length; ix++) {
                                numes.push(finaltotal[ix]);
                            }
                            $("#finaltotal").attr("value",sum(numes))    
                        });     
        ...
        function detail(elem){
            ...
            $.ajax({
                ...
                success: function(response) { 
                    ...
                    datarow+="<th>No Batch</th>";
                    datarow+="<th>Nama Item</th>";
                    datarow+="<th>Harga Jual 1</th>"; 
                    datarow+="<th>Harga Jual 2</th>"; 
                    datarow+="<th>Harga Jual 3</th>"; 
                    datarow+="<th>Harga Jual 4</th>"; 
                    ...
                    $.each(response.datasub, function(i, itemsub) {
                        ...
                        datarow+="<td>"+itemsub.no_bet+"</td>"; 
                        datarow+="<td>"+itemsub.nama_item+"</td>";
                        datarow+="<td>"+itemsub.harga1+"</td>";
                        datarow+="<td>"+itemsub.harga2+"</td>";
                        datarow+="<td>"+itemsub.harga3+"</td>";
                        datarow+="<td>"+itemsub.harga4+"</td>"; 
                        datarow+="<td>"+itemsub.tgl_expired+"</td>"; 
        ...
        $(add_button_mg).click(function(e){
            ...
            if(x < max_fields){
                ...
                formtambah+=' <td><input type="text" name="no_bet[]" class="form-control no-bet'+x+'"></td>';
                ...
                formtambah+='<td><input type="text" name="harga[]" class="form-control harga'+x+'" required></td>';
                formtambah+='<td><input type="text" name="harga1[]" class="form-control harga1'+x+'" required></td>';
                formtambah+='<td><input type="text" name="harga2[]" class="form-control harga2'+x+'" required></td>';
                formtambah+='<td><input type="text" name="harga3[]" class="form-control harga3'+x+'" required></td>';
                formtambah+='<td><input type="text" name="harga4[]" class="form-control harga4'+x+'" required></td>';
                ...
                $.ajax({
                    ...
                    success: function(response) {  
                        ...
                        $.each(response.datasub, function(i, itemsub) {
                            ...
                            datarow+=' <td><input type="text" value="'+itemsub.no_bet+'" name="no_bet[]" class="form-control no_bet'+x+'"></td>';
                            ...
                            datarow+='<td><input type="text" value="'+itemsub.harga1_int+'"  name="harga1[]" class="form-control mask_priceedit" required></td>';
                            datarow+='<td><input type="text" value="'+itemsub.harga2_int+'"  name="harga2[]" class="form-control mask_priceedit" required></td>';
                            datarow+='<td><input type="text" value="'+itemsub.harga3_int+'"  name="harga3[]" class="form-control mask_priceedit" required></td>';
                            datarow+='<td><input type="text" value="'+itemsub.harga4_int+'"  name="harga4[]" class="form-control mask_priceedit" required></td>'; 
        ...
        $(add_button_mgEdit).click(function(e){
            ...
            if(x < max_fieldsEdit){
                ...
                formtambah+='<td><input type="hidden" class="kode-item'+x+'" name="kode_item[]"><input type="hidden" class="nama-item'+x+'" name="nama_item[]">';
                formtambah+=' <input type="text" name="sku[]" class="form-control sku'+x+'"></td>';
                formtambah+='<td><input type="text" name="no_bet[]" class="form-control no_bet'+x+'"></td>';
                formtambah+='<td><input type="text"  class="form-control nama-item'+x+'"></td>';
                formtambah+='<td><input type="text" name="tgl_expired[]"  class="form-control tgl_expired"></td>'; 
                formtambah+='<td><input type="text" name="harga1[]" class="form-control mask_price1'+x+'" required></td>';
                formtambah+='<td><input type="text" name="harga2[]" class="form-control mask_price2'+x+'" required></td>';
                formtambah+='<td><input type="text" name="harga3[]" class="form-control mask_price3'+x+'" required></td>';
                formtambah+='<td><input type="text" name="harga4[]" class="form-control mask_price4'+x+'" required></td>';
