...
<html class="fixed sidebar-left-collapsed">
	...
	<body class="bgbody">
		<section class="body">
			...
			<div class="inner-wrapper"> 
				...
				<section role="main" class="content-body">
                    ...
                    <form id="Formulir" method="GET" action="<?php echo base_url();?>laporan/excel_penerimaan/" target="_blank">
					<!-- start: page --> 
                    <section class="panel"> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select  data-plugin-selectTwo class="form-control"  id="penerima" name="penerima">  
                                            <option value="">Semua Penerima</option>
                                            <?php foreach ($penerima as $supp): ?>
                                            <option value="<?php echo $supp->penerima;?>"><?php echo $supp->penerima;?></option>
                                            <?php endforeach; ?>
                                        </select> 
                                    </div>
                                </div>
        ...
        function searchFilter(page_num) { 
            ...
            $.ajax({
				type: 'GET',
				url: '<?php echo base_url(); ?>laporan/laporanpenerimaan/'+page_num,
				data: 'page='+page_num+'&penerima='+penerima+'&firstdate='+firstdate+'&lastdate='+lastdate,success: function (html) { 
					$('#postList').html(html);
