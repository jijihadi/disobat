...
<html class="fixed sidebar-left-collapsed">
	...
	<body class="bgbody">
		<section class="body">
			...
			<div class="inner-wrapper"> 
				...
				<section role="main" class="content-body">
                    ...
                    <form id="Formulir" method="GET" action="<?php echo base_url();?>laporan/excel_keuangan/" target="_blank">
					<!-- start: page --> 
                    <section class="panel"> 
        ...
        function searchFilter(page_num) { 
            ...
            $.ajax({
				type: 'GET',
				url: '<?php echo base_url(); ?>laporan/laporankeuangan/'+page_num,
				data: 'page='+page_num+'&firstdate='+firstdate+'&lastdate='+lastdate,success: function (html) { 
					$('#postList').html(html);
